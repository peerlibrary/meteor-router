(function() {
  ...
  Router.prototype.add = function(path, endpoint) {
    ...
    if (_.isObject(path) && ! _.isRegExp(path)) {
      ...
      endpoint.as && self._setUpNamedRoute(endpoint.as, path, endpoint)
  ...
  Router.prototype._setUpNamedRoute = function(name, path, endpoint) {
    var self = this;
    ...
    route.documentId = endpoint.documentId;
    route.documentName = endpoint.documentName;
